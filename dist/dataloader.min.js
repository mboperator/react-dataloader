...
/***/ function(module, exports, __webpack_require__) {
	...
	var FilteredDatasource = __webpack_require__(3);
	var Collection = __webpack_require__(4);
	var ObjectTest = __webpack_require__(5);

	// Exports components
	module.exports = {
	  FilteredDatasource: FilteredDatasource,
	  Datasource: Datasource,
	  DependentDatasource: DependentDatasource,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reflux = __webpack_require__(9);
	var _ = __webpack_require__(10);
	var UtilityMixin = __webpack_require__(7);
	var DSManager = __webpack_require__(8);
	...
	var Datasource = React.createClass({
	  ...
	  mixins: [Reflux.ListenerMixin, UtilityMixin],
	  ...
	  _prepareDatasource: function _prepareDatasource(props) {
	    var name = props.name;
	    var basePath = props.basePath;
	    var endpoint = props.endpoint;
	    var storeType = props.storeType;
	    var idAttr = props.idAttr;
	    var headers = props.headers;

	    this.dataSource = DSManager.instance().getStore({ name: name, basePath: basePath, endpoint: endpoint, storeType: storeType, idAttr: idAttr, headers: headers });
	    this.listenTo(this.dataSource, this.onStoreChange);
	  },

	  _reloadCollection: function _reloadCollection(id) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FilteredDatasource = React.createClass({
	  ...
	  _registerView: function _registerView(props) {
	    var tag = props.tag;
	    var sortBy = props.sortBy;
	    var filter = props.filter;

	    this.dataSource.listenables.registerView(tag, { sortBy: sortBy, filter: filter });
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reflux = __webpack_require__(9);
	var DataActionGenerator = __webpack_require__(11);
	var nsync = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataActionGenerator = function DataActionGenerator(resourceName) {
	  ...
	  var actions = Reflux.createActions(['add', 'update', 'destroy', 'filter', 'sort', 'registerView']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Nsynchronizer = {
	   ...
	   */
	  registerStore: function registerStore(options, store, dependentStore) {
	    this.store = store;
	  ...
	  populate: function populate() {
	    ...
	    this.client.getAll().then(function (objects) {
	      ...
	      _this.store.destroyAll();
	      _this.store.setCollection(objects);
	    }).fail(function (err) {
	      console.error(err);
	    });
	  },
	  ...
	  update: function update(object) {
	    this.client.update(object).then(function (object) {}).fail(function (err) {
	      console.error(err);
	    });
	  },
	  ...
	  * @public Push store deletions to remote
	  ...
	  destroy: function destroy(id) {
	    this.client.destroy(id).then(function (result) {}).fail(function (err) {
	      console.error(err);
	    });
	  },
	  ...
	  * @public Push store additions to remote
	  ...
	  add: function add(object) {
	    this.client.add(object).then(function (object) {}).fail(function (err) {
	      console.error(err);
	    });
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var loki = __webpack_require__(33);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ActionMethods = __webpack_require__(18);

	exports.ListenerMethods = __webpack_require__(19);

	exports.PublisherMethods = __webpack_require__(20);

	exports.StoreMethods = __webpack_require__(21);

	exports.createAction = __webpack_require__(22);

	exports.createStore = __webpack_require__(23);
	...
	exports.listenTo = __webpack_require__(27);

	exports.listenToMany = __webpack_require__(28);


	var maker = __webpack_require__(29).staticJoinCreator;
	 ...
	 */
	exports.__keep = __webpack_require__(31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var superagent = __webpack_require__(48);
	...
	var Client = (function () {
	  ...
	  _createClass(Client, [{
	     ...
	     */
	    value: function _getResourceUrl() {
	    ...
	    value: function add(object) {
	      ...
	      superagent.post(url).set(this.headerOptions).send(object).end(function (err, res) {
	        if (err) {
	    ...
	    value: function destroy(id) {
	      ...
	      superagent.del(url).set(this.headerOptions).end(function (err, res) {
	        if (err) {
	          return deferred.reject(err);
	        } else if (300 < res.status && res.status < 500) {
	          console.warn('ClientError:', res.status, url);
	    ...
	    value: function update(object) {
	      ...
	      superagent.put(url).set(this.headerOptions).send(object).end(function (err, res) {
	        if (err) {
	          return deferred.reject(err);
	        } else if (300 < res.status && res.status < 500) {
	          console.warn('ClientError:', res.status, url);
	    ...
	    value: function get(id) {
	      ...
	      superagent.get(url).set(this.headerOptions).end(function (err, res) {
	        if (err) {
	          return deferred.reject(err);
	        } else if (300 < res.status && res.status < 500) {
	          console.warn('ClientError:', res.status, url);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(30),
	    maker = __webpack_require__(29).instanceJoinCreator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(30),
	    Reflux = __webpack_require__(15),
	    Keep = __webpack_require__(31),
	    mixer = __webpack_require__(39),
	    allowed = {preEmit:1,shouldEmit:1},
	    bindMethods = __webpack_require__(40);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(30),
	    ListenerMethods = __webpack_require__(19);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var slice = Array.prototype.slice,
	    _ = __webpack_require__(30),
	    createStore = __webpack_require__(23),
	    strategyMethodNames = {
	        strict: "joinStrict",
	        first: "joinLeading",
	        last: "joinTrailing",
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.EventEmitter = __webpack_require__(47);
	...
	(function (root, factory) {
	  ...
	  return (function () {
	    ...
	    function LokiFsAdapter() {
	      this.fs = __webpack_require__(49);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var joinClasses = __webpack_require__(46);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(38), __webpack_require__(52).setImmediate))
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(setImmediate, clearImmediate) {var nextTick = __webpack_require__(56).nextTick;
