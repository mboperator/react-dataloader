	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          "tbody",
	          null,
	          this.props.data && this.props.data.map(function (object, i) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var loki = __webpack_require__(36);
	...
	var Client = (function () {
	  ...
	  _createClass(Client, [{
	    ...
	    value: function add(object) {
	      ...
	      superagent.post(url).send(object).end(function (err, res) {
	        if (err) {
	    ...
	    value: function update(object) {
	      ...
	      superagent.put(url).send(object).end(function (err, res) {
	        if (err) {
	          return deferred.reject(err);
	        } else if (300 < res.status && res.status < 500) {
	          console.warn('ClientError:', res.status, url);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Promise = __webpack_require__(48);
	...
	(function (root, factory) {
	  ...
	  return (function () {
	    ...
	    function LokiFsAdapter() {
	      this.fs = __webpack_require__(50);
	    }
