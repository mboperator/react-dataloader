...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataStoreManager = (function () {
	  ...
	  _createClass(DataStoreManager, [{
	     ...
	     */
	    value: function getStore(options, overrides) {
	     ...
	     */
	    value: function shared(options, overrides) {
	      var name = options.name;
	      var builder = options.builder;
	      var _overrides$store = overrides.store;
	      var store = _overrides$store === undefined ? {} : _overrides$store;
	      var _overrides$synchronizer = overrides.synchronizer;
	      var synchronizer = _overrides$synchronizer === undefined ? null : _overrides$synchronizer;
	      var _overrides$client = overrides.client;
	      var client = _overrides$client === undefined ? null : _overrides$client;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var defaultActions = ['add', 'update', 'destroy', 'filter', 'sort', 'search', 'registerView', 'resetView', 'reload', 'populate', 'destroyAll', 'setObject', 'setCollection'];
	...
	var DataActionGenerator = function DataActionGenerator(resourceName) {
	  var customActions = arguments[1] === undefined ? [] : arguments[1];
