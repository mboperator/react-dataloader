...
/***/ function(module, exports, __webpack_require__) {
	...
	var DependentDatasource = __webpack_require__(45);
	var FilteredDatasource = __webpack_require__(46);
	var Collection = __webpack_require__(47);
	var ObjectTest = __webpack_require__(48);
	var CrudMixin = __webpack_require__(49);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UtilityMixin = __webpack_require__(26);
	var DataMixin = __webpack_require__(28);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reflux = __webpack_require__(3);
	var DataActionGenerator = __webpack_require__(30);
	var nsync = __webpack_require__(31);
	...
	var urlBuilders = {
	  ...
	  procore: __webpack_require__(44)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var reqwest = __webpack_require__(34);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CrudMixin = {
	  ...
	  handleUpdate: function handleUpdate() {
	    ...
	    this.props.actions.update(object).then(function () {
	      _this.context.router.transitionTo('view', { id: _this.props.objectId });
	    });;
	  },

	  removeTmpIds: function removeTmpIds(object) {
	    if (object.id.match('temp')) {
	      object.id = null;
	    }
	    return object;
	  },
	  ...
	  saveChecklist: function saveChecklist(object, stores) {
	    var _this2 = this;
	    ...
	    _.each(list.sections_attributes, function (section) {
	      var items = itemStore.find({ parent_id: section.id });
	      section.items_attributes = items.map(_this2.removeTmpIds);
	      section.id = null;
	    });
