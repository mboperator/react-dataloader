...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataActionGenerator = function DataActionGenerator(resourceName) {
	  ...
	  var actions = Reflux.createActions(['add', 'update', 'destroy', 'filter', 'sort', 'search', 'registerView', 'resetView', 'populate', 'destroyAll', 'setCollection']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var loki = __webpack_require__(39);
	var _ = __webpack_require__(10);
	...
	function uniqueKeys(array) {
	  return _.chain(array).map(function (obj) {
