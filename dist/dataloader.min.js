...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reflux = __webpack_require__(5);
	var DataActionGenerator = __webpack_require__(36);
	var nsync = __webpack_require__(37);
	...
	var Nsynchronizer = {
	  ...
	  * @public Fetch Object from remote
	  ...
	  update: function update(object) {
	    ...
	    this.client.update(object).then(function (responseObject) {
