...
/***/ function(module, exports, __webpack_require__) {
	...
	var DependentDatasource = __webpack_require__(42);
	var BasicDatasource = __webpack_require__(43);
	var FilteredDatasource = __webpack_require__(44);
	var Collection = __webpack_require__(45);
	var ObjectTest = __webpack_require__(46);
	var DSManager = __webpack_require__(27);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UtilityMixin = __webpack_require__(24);
	var DataMixin = __webpack_require__(26);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Reflux.ActionMethods = __webpack_require__(5);
	...
	var _ = Reflux.utils = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(7),
	    ActionMethods = __webpack_require__(5),
	    PublisherMethods = __webpack_require__(17),
	    Keep = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var storeTemplates = {
	  ...
	  unique: __webpack_require__(38)
	};

	var urlBuilders = {
	  'default': __webpack_require__(40),
	  dependent: __webpack_require__(41)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function defaultDeserializer(query, object) {
	...
	var Nsynchronizer = {
	   ...
	   */
	  onStoreChange: function onStoreChange(action, data, trigger, prevData) {
	  ...
	  setDeserializer: function setDeserializer() {
	    var deserializer = arguments.length <= 0 || arguments[0] === undefined ? defaultDeserializer : arguments[0];
	  ...
	  * @public Fetch Object from remote
	   ...
	   */
	  update: function update(object, prevObject) {
	    var _this3 = this;
	    ...
	    this.client.update(object, this.serializer).then(function (responseObject) {
	      ...
	      _this3._updateError(object, prevObject);
	      console.error(err);
	    });
	  },

	  _updateError: function _updateError(object, prevObject) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var q = __webpack_require__(31);
	var _ = __webpack_require__(25);
	var reqwest = __webpack_require__(32);
	...
	var Client = (function () {
	  ...
	  _createClass(Client, [{
	    ...
	    value: function add(object) {
	      var serializer = arguments.length <= 1 || arguments[1] === undefined ? this.defaultSerializer : arguments[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9), __webpack_require__(8).setImmediate))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var loki = __webpack_require__(34);
	var _ = __webpack_require__(25);
	var uuid = __webpack_require__(37);
	/**
	 * @class LowkeySource
	...
	function generateStore(options) {
	  ...
	  return {
	    ...
	    destroyAll: function destroyAll() {
	      var trigger = arguments.length <= 0 || arguments[0] === undefined ? true : arguments[0];
	    ...
	    registerView: function registerView(tag, viewParams) {
	      ...
	      var columnDefinitions = viewParams.columnDefinitions;
	...
	function getPropAccessor(columnDefinitions, key) {
	  var def = _.filter(columnDefinitions, function (def) {
	    return def.key === key;
	  });
	...
	function _buildFilter(key, value, columnDefinitions) {
	  ...
	  var propAccessor = getPropAccessor(columnDefinitions, key);
	  return function (object) {
	    var prop = propAccessor ? propAccessor(object) : object[key];
	    var formattedProp = String(prop).toLowerCase();
	    if (value === undefined) {
	      return !object[key];
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var q = __webpack_require__(31);
	var _ = __webpack_require__(25);
	var qwest = __webpack_require__(32);
