...
/***/ function(module, exports, __webpack_require__) {
	...
	var FilteredDatasource = React.createClass({
	  ...
	  _registerView: function _registerView(props) {
	    ...
	    this.dataSource.listenables.registerView(tag, { sortBy: sortBy, filters: filters, search: search });
	  },
	  ...
	  _repopulate: function _repopulate(props) {
	    if (!props.data) {
	      return this.dataSource.listenables.populate();
	    }
	    var _props$config = props.config;
	    var idAttr = _props$config.idAttr;
	    var fkAttr = _props$config.fkAttr;
	    var idRootAttr = _props$config.idRootAttr;
	    var fkRootAttr = _props$config.fkRootAttr;
	  ...
	  shouldComponentUpdate: function shouldComponentUpdate(nextProps, nextState) {
	    return !_.isEqual(nextState.data, this.state.data) || !_.isEqual(nextProps.data, this.props.data);
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var loki = __webpack_require__(40);
	var _ = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function procoreUrlBuilder(options) {
	  ...
	  var rootResource = options.rootResource;
	  var fkRootAttr = options.fkRootAttr;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.EventEmitter = __webpack_require__(37);
