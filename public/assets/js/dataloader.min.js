	  ...
	  return {
	    ...
	    filter: function filter(tag, filterQuery) {
	      if (!this.dynamicViews[tag]) {
	        this.dynamicViews[tag] = { filters: {}, sortBy: {}, search: '', columnDefinitions: this.columnDefinitions };
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FilteredDatasource = React.createClass({
	  ...
	  _registerView: function _registerView(props, state) {
	    ...
	    return dataSource.listenables.registerView(tag, { sortBy: sortBy, filters: filters, search: search, columnDefinitions: columnDefinitions });
	  },
