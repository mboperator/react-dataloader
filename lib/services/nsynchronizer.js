...
var Nsynchronizer = {
  ...
  populate(object, params) {
    if (_.isEmpty(object) && _.isEmpty(params)) return;
  ...
  * @public Fetch Object from remote
  ...
  update(object, prevObject) {
    ...
    .fail(err => {
      ...
      this._updateError(object, prevObject);
      console.error(err);
    });
  },

  _updateError(object, prevObject) {
    this.store.listenables.setObject(prevObject);
  },
